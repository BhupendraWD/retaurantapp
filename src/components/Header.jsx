                    ...
                    <div className='relative'>
                        ...
                        />
                        {
                         ...
                         flex flex-col absolute top-12  right-0'>
                                    {
                                        user && user.email === "bhupendrasingh@acmeintech.in" && (
                                            <Link to={"/createItem"}>
                                                <p className='px-4 py-2 flex items-center gap-1 cursor-pointer hover:bg-slate-100
                        ...
                        isMenu && (
                         ...
                         flex flex-col absolute top-12  right-0'>
                                ...
                                <ul className='flex flex-col'>
                                    <Link to={'/'} className='text-base text-textColor hover:text-headingColor duration-100 
                                        trasition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'>Home</Link>
                                    <li className='text-base text-textColor hover:text-headingColor duration-100 
                                        trasition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'>Menu</li>
                                    <li className='text-base text-textColor hover:text-headingColor duration-100 
                                        trasition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'>About</li>
                                    <li className='text-base text-textColor hover:text-headingColor duration-100 
                                        trasition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'>Service</li>
                                </ul>
                                <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-1 cursor-pointer hover:bg-gray-300
                             transition-all duration-100 ease-in-out text-textColor text-base'
                                    onClick={() => logout()}
                                >Logout <MdLogout /></p>
                            </motion.div>
